...
class RwAdapter {
  ...
  getDataset() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      this.tableName =
        ((_b =
          (_a = dataset) === null || _a === void 0 ? void 0 : _a.attributes) ===
          null || _b === void 0
          ? void 0
          : _b.tableName) || null;
      return dataset;
  ...
  getWidget(dataset, widgetId) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const url = `${
        this.endpoint
      }/widget/${resolveWidgetId}?${applications.join(
        ","
      )}&env=${env}&language=${locale}&includes=${includes}&page[size]=999`;
  ...
  handleSave(consumerOnSave, dataService, application = "rw", editorState) {
    ...
    this.widget_params.forEach((param) => {
      if (param in configuration) {
        widgetParams = Object.assign(Object.assign({}, widgetParams), {
  ...
  filterUpdate(filters, fields, widget, dataset) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const configuration = Object.assign(
        Object.assign({}, widgetConfig.paramsConfig),
        { title: name, caption: description }
      );
      const out = yield core_1.FiltersService.handleFilters(
        filters,
        {
          column: "name",
          values: "value",
