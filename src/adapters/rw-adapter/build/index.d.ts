...
export default class RwAdapter implements Adapter.Service {
    ...
    handleSave(consumerOnSave: any, dataService: any, application: string, editorState: any): void;
    filterSerializer(filters: any): any;
    requestData(sql: any, dataset: any): Promise<any>;
    filterUpdate(filters: any, fields: any, widget: any, dataset: any): Promise<any[]>;
}
