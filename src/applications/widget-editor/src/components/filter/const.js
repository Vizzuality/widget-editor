...
// General Filter structure types
...
export const STRING_TYPES = [
  ...
  TYPE_TEXT_CONTAINS,
  TYPE_TEXT_NOT_CONTAINS,
  TYPE_TEXT_STARTS_WITH,
  TYPE_TEXT_ENDS_WITH
];
...
export const FILTER_STRING_INDICATOR_TYPES = [
  { label: "Filter by values", value: TYPE_FILTER_ON_VALUES },
  { label: "Text Contains", value: TYPE_TEXT_CONTAINS },
  { label: "Text does not contain", value: TYPE_TEXT_NOT_CONTAINS },
  { label: "Text starts with", value: TYPE_TEXT_STARTS_WITH },
  { label: "Text ends with", value: TYPE_TEXT_ENDS_WITH }
];
