...
export const StyledTitle = styled.h4.withConfig({
...
export const StyledIcons = styled.div.withConfig({
  displayName: "style__StyledIcons",
  componentId: "kjyq8o-3"
})(["display:flex;align-items:stretch;justify-content:flex-start;flex-wrap:wrap;margin-left:-8px;margin-right:-8px;"]);